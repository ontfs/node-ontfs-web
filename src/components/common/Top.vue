      ...
      <el-row>
        ...
        >
          <div>
            <a href="/"
              ><img
                style=" height: 23px;margin: 17px 0 0 20px;"
            ...
            <el-dropdown @command="handleCommand" trigger="click">
              <span class="el-dropdown-link">
                <span class="title-lang">
                  ...
                  <i
                    class="el-icon-arrow-down el-icon--right hide-when-mobile"
                  ></i>
                </span>
              </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="en"
                  ><span
                    :class="
                      $i18n.locale == 'en' ? 'lang-active' : 'lang-noactive'
                    "
                    >English</span
                  ></el-dropdown-item
                >
                <el-dropdown-item command="zh"
                  ><span
                    :class="
                      $i18n.locale == 'zh' ? 'lang-active' : 'lang-noactive'
                    "
                    >中文</span
                  ></el-dropdown-item
                >
