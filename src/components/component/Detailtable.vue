  ...
  <div class="d-table-container">
    <div class="d-table-content">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane :label="$t('tab.balance')" name="first">{{$t('tab.balance')}}</el-tab-pane>
        <el-tab-pane :label="$t('tab.transactions')" name="second">{{$t('tab.transactions')}}</el-tab-pane>
      ...
      <transactions-nav v-if="transactionsFlag" :address="address"></transactions-nav>
